package com.agree.contract.infrastructure.modulecontract.customerContractApplicationForm.mapper;
 ...
 */
@Mapper
public interface CustomerContractApplicationFormMapper extends BaseMapper<CustomerContractApplicationFormPo> {
